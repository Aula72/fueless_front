...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/14.0.4/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/14.0.4/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/14.0.4"
      }
    )
