...
function useDisplayValue(itemText, valueItem) {
    ...
    const displayValue = useMemo(() => {
        var _a;
        return valueItem === undefined ? '' : (_a = renderItemText(valueItem, itemText)) !== null && _a !== void 0 ? _a : '';
    }, [valueItem, itemText]);
    return displayValue;
}
...
const SelectSingle = forwardRef(({ ariaDescribedBy, assistiveText, data, helpSourceLink, helpSourceText, isDisabled: propIsDisabled, isLoading: propIsLoading, isReadonly: propIsReadonly, isRequired, isRequiredShown, itemText, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, messages, onCommit, onFilter, onLoadRange, placeholder, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, valueItem, variant = 'default', virtualKeyboard }, ref) => {
    ...
    const { collectionProps, dropdownArrowEventHandlers, dropdownEventHandlers, dropdownRef, inputEventHandlers, isDropdownOpen, isFocused, isUserFiltering, mainFieldRef, mouseProps, searchText, userInput } = useSelectSingle({
        data,
