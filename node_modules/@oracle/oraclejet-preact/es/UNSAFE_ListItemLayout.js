...
const childrenStyles = "r51lf3"; // TODO: revisit idea of negative margin when selector has a proper API for handling spacing
// Jira: JET-54543
// negative margin added to selector

const selectorStyles = "_1oez59z"; // most content will be vertically centered

const centerVerticalStyles = "_76cfun"; // extra spacing is needed between meta, trailing, and action components

const leftPaddingStyles = "_1pwf8ax"; // the central text area displays overline, primary, secondary, and tertiary in a column

const flexColumnStyles$1 = "_11f6gco"; // "extra" components in row 1 and the link in row 2 are justified on the righthand side of the list item layout

const flexRowStyles = "ov92id";
const rightJustifyStyles = "brg288";
const rowAlignStyles = "_8ba1hz";
