...
import { u as useFloating, o as offset, b, D, L, m, N } from './index-35a194f0.js';
 ...
 */
const Floating = forwardRef(({ children, onClickOutside, placement = 'bottom', anchorRef, offsetValue, class: className, tail = 'none', flipOptions = { mainAxis: true, crossAxis: false }, shiftOptions = { mainAxis: true, crossAxis: false }, onPosition }, ref) => {
