...
import './LoadMoreCollection-69d25dfc.js';
...
const rootStyles = "_1iu3oqv"; // This component renders a badge showing the number of selected values
...
function useSelectMultiple({ data: propData, inputRef, isDisabled, isFocused: propIsFocused, isReadonly, onCommit, onFilter, onLoadRange: propOnLoadRange, valueItems }) {
    ...
    const dropdownEventHandlers = useMemo(() => {
        return mergeProps({ onAutoDismiss: baseHandleDropdownAutoDismiss }, { onAutoDismiss: myHandleDropdownAutoDismiss });
...
const SelectMultiple = forwardRef(({ ariaDescribedBy, assistiveText, data: propData, helpSourceLink, helpSourceText, isDisabled: propIsDisabled, isLoading: propIsLoading, isReadonly: propIsReadonly, isRequired, isRequiredShown, itemText, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, messages, onCommit, onFilter, onLoadRange: propOnLoadRange, placeholder, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, valueItems, variant = 'default', virtualKeyboard }, ref) => {
    ...
    const dropdownListContent = isEmptyResults ? (jsx(EmptyResults, {})) : (jsx(DefaultList, Object.assign({}, collectionProps, { accessibleSummary: label !== null && label !== void 0 ? label : '', data: data, itemText: itemText, onLoadRange: onLoadRange, searchText: isDropdownSelectedOnlyView ? undefined : isUserFiltering ? searchText : undefined, selectionMode: "multiple" })));
    return (jsxs(Fragment, { children: [jsx(FormFieldContext.Provider, Object.assign({ value: formFieldContext }, { children: jsx(TextField, Object.assign({ endContent: endContent, inlineUserAssistance: inlineUserAssistance, mainContent: mainContent, mainFieldRef: mainFieldRef, onBlur: focusProps === null || focusProps === void 0 ? void 0 : focusProps.onfocusout, onFocus: focusProps === null || focusProps === void 0 ? void 0 : focusProps.onfocusin }, textFieldProps, fieldLabelProps, mouseProps)) })), jsxs(Dropdown, Object.assign({ dropdownRef: dropdownRef, id: dropdownId, isOpen: isDropdownOpen &&
                    data !== undefined &&
                    (data === null || data.totalSize > 0 || isBeforeDataFetch(data) || isEmptyResults), anchorRef: mainFieldRef }, dropdownEventHandlers, { children: [jsx(DropdownList, Object.assign({ hasBottomGap: dropdownInlineUserAssistance === undefined, isLoading: data === null }, { children: dropdownListContent })), dropdownInlineUserAssistance] }))] }));
});
