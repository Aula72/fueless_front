...
var Spacer = require('./Spacer-eaa3e99c.js');
var stringUtils = require('./stringUtils-1981a409.js');
...
const DisabledFilePicker = ({
  ...
  return jsxRuntime.jsx("div", Object.assign({
    class: classNames.classNames([styles.base, styles.inner, width === undefined && styles.maxWidth, 'oj-c-filepicker-disabled']),
    role: "button",
    "aria-label": getAriaLabel({
      accessibleLabel,
      isDisabled: true,
    ...
    children: children && childrenContainer(children) || getDefaultTriggerContent(true, primaryText, secondaryText, translations, selectionMode)
  }));
};
/**
...
const CustomFilePicker = props => {
  ...
  return jsxRuntime.jsx("div", Object.assign({
    ...
    children: props.children && childrenContainer(props.children)
  }));
};
/**
...
const styles = {
  ...
  inner: "_1csvcs3",
  hover: "_1y4a2kz",
  pseudohover: "_1vqcaya"
};
const childrenStyles = "_14lquol";

exports.FilePicker = FilePicker;
/*  */
//# sourceMappingURL=FilePicker-3faeacec.js.map
