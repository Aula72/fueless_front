...
function CircularReferenceLine({
  ...
  return jsxRuntime.jsx("div", {
    ...
    style: {
      ...
      backgroundColor: color ? color : 'var(--oj-c-PRIVATE-DO-NOT-USE-dvt-reference-object-line-color)',
...
function getThresholdsProps(meterInfo, thresholds, isTrackRendered, trackColor, innerRadius) {
    ...
    for (let i = 0; i < numOfThreshold; i++) {
        ...
        thresholdProps.push({
            clipPath,
            color: threshold === null || threshold === void 0 ? void 0 : threshold.color,
            size: trackSize,
            section
        });
...
const styles = {
  ...
  mdfull: "_1xy5b21",
  lgfull: "va5oof",
  lgHorizontal: "_1bzrslh",
  lgVertical: "shg10j",
  smHorizontal: "_1ul71zu",
  smVertical: "_18nc238",
  mdHorizontal: "rkqj7s",
  mdVertical: "xk0ij0",
  smFull: "_1ny5xe5",
  mdFull: "q9iqic",
  lgFull: "_1674vsl",
  centerContent: "mwgpfo",
  thresholds: "_1glkpi6"
};
const childrenStyles = "vl0s6r";
const circleWrapper = {
  base: "pkeepd"
};
const circleTrack = {
...
/*  */
//# sourceMappingURL=MeterCircle-b4bb48bc.js.map
