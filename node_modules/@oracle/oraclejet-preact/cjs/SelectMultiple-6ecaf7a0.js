...
var Chip = require('./Chip-67746a23.js');
...
function useSelectMultiple({ data: propData, inputRef, isDisabled, isFocused: propIsFocused, isReadonly, onCommit, onFilter, onLoadRange: propOnLoadRange, valueItems }) {
    ...
    const dropdownEventHandlers = hooks.useMemo(() => {
        return utils_UNSAFE_mergeProps.mergeProps({ onAutoDismiss: baseHandleDropdownAutoDismiss }, { onAutoDismiss: myHandleDropdownAutoDismiss });
...
/*  */
//# sourceMappingURL=SelectMultiple-6ecaf7a0.js.map
