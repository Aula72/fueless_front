...
function mergeEnvironment(env1, env2) {
    ...
    return {
        ...
        colorScheme: (_a = env2 === null || env2 === void 0 ? void 0 : env2.colorScheme) !== null && _a !== void 0 ? _a : env1.colorScheme,
        scale: (_b = env2 === null || env2 === void 0 ? void 0 : env2.scale) !== null && _b !== void 0 ? _b : env1.scale
    };
}
/**
