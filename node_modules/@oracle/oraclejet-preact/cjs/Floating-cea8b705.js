...
var hooks_UNSAFE_useFloating = require('./index-b2f63b8c.js');
...
const FloatingTail = compat.forwardRef(({}, arrowRef) => {
    return (jsxRuntime.jsxs("div", Object.assign({ ref: arrowRef }, { children: [" ", jsxRuntime.jsx("div", {}), " "] })));
});
 ...
 */
const Floating = compat.forwardRef(({ children, onClickOutside, placement = 'bottom', anchorRef, offsetValue, class: className, tail = 'none', flipOptions = { mainAxis: true, crossAxis: false }, shiftOptions = { mainAxis: true, crossAxis: false }, onPosition }, ref) => {
    ...
    const { x, y, reference, floating, refs } = hooks_UNSAFE_useFloating.useFloating({
        placement: placement,
        middleware: [
            hooks_UNSAFE_useFloating.offset(offsetValue),
            hooks_UNSAFE_useFloating.b({
                mainAxis: flipOptions.mainAxis,
                crossAxis: flipOptions.crossAxis
            }),
            hooks_UNSAFE_useFloating.D({
                mainAxis: shiftOptions.mainAxis,
                crossAxis: shiftOptions.crossAxis,
                limiter: hooks_UNSAFE_useFloating.L({
                    mainAxis: shiftOptions.mainAxis,
                    crossAxis: shiftOptions.crossAxis
                })
            }),
    ...
    hooks_UNSAFE_useOutsideClick.useOutsideClick({ isDisabled: false, ref: refs.floating, handler: onClickOutside });
    hooks.useLayoutEffect(() => {
    ...
    const stableRef = hooks.useMemo(() => utils_PRIVATE_refUtils.mergeRefs(ref, floating), [ref, floating]);
    const content = (jsxRuntime.jsxs("div", Object.assign({ class: className, ref: stableRef, style: {
            display: 'block',
            visibility: x == null && y == null ? 'hidden' : 'visible',
            position: 'absolute',
            top: y !== null && y !== void 0 ? y : '',
            left: x !== null && x !== void 0 ? x : ''
        } }, { children: [children, jsxRuntime.jsx(FloatingTail, { ref: arrowRef })] })));
    return content;
});

exports.Floating = Floating;
/*  */
//# sourceMappingURL=Floating-cea8b705.js.map
