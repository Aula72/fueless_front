...
class RootViewModel {
    ...
    constructor() {
        ...
        this.toolbarButtonDataSource = [
            new ToolBarButtonDataSourceItem({"id": "delete", "label": "Delete", "iconClasses": "oj-ux-ico-trash",
            "clickCallback": this.deleteCallback}),
            new ToolBarButtonDataSourceItem({"id": "copy","label": "Copy", "iconClasses": "oj-ux-ico-copy",
            "clickCallback": this.copyCallback}),
            new ToolBarButtonDataSourceItem({"id": "edit","label": "Edit", "iconClasses": "oj-ux-ico-edit",
            "clickCallback": this.editCallback}),
            new ToolBarButtonDataSourceItem({"id": "download","label": "Download", "iconClasses": "oj-ux-ico-download",
            "clickCallback": this.downloadCallback}),
            new ToolBarButtonDataSourceItem({"id": "share","label": "Share", "iconClasses": "oj-ux-ico-share",
