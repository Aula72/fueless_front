...
/**
 * This is the base class for oj-combobox-one WebElement, and is generated from the
 * component's metadata. Do not modify these contents since they'll be replaced
 * during the next generation.
 * Put overrides into the WebElements's subclass, OjComboboxOne.ts.
 */
export class OjComboboxOneBase extends OjWebElement {
  /**
  ...
  /**
   * Gets the value of <code>filterOnOpen</code> property.
   * Whether to filter the drop down list on open.
   * @return The value of <code>filterOnOpen</code> property.
   *
   */
  public getFilterOnOpen(): Promise<string> {
    return this.getProperty<string>('filterOnOpen');
  }
   ...
   * Specifies whether the component is required or optional. See the Help documentation for more information. * @expose
...
export interface ValueOption {
  ...
  label: string;
  /**
   * current value of multiple selected JET Combobox values
   */
  value: any;
}
