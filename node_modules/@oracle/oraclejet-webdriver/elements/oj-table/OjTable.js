...
class OjTable extends OjTableBase_1.OjTableBase {
    ...
    async findCell(itemLocator) {
        ...
        const el = await this.getDriver().executeAsyncScript(`
    ...
    `, this, itemLocator.rowIndex, itemLocator.columnIndex, itemLocator.rowKey, itemLocator.columnKey);
        if (el) {
    ...
    `, this, itemLocator.rowIndex, itemLocator.rowKey);
        if (el) {
            return (0, __1.slotProxy)(el, this);
        }
        else {
    ...
    `, this, itemLocator.columnIndex, itemLocator.columnKey);
        if (el) {
            return (0, __1.slotProxy)(el, this);
        }
        else {
     ...
     */
    async doSort(header, direction) {
        await this.whenReady();
        const msg = await this.getDriver().executeAsyncScript(`
      const element = arguments[0];
      const done = arguments[3];
