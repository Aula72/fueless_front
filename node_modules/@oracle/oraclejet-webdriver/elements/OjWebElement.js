    ...
    async whenBusyContextReady() {
      ...
      `;
        const ret = await this.getDriver()
            ...
            .catch(async (ex) => {
            const openStates = await (0, busy_context_utils_1.getBusyStates)(this.getDriver());
