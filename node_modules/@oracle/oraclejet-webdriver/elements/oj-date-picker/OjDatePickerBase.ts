...
/**
 * This is the base class for oj-date-picker WebElement, and is generated from the
 * component's metadata. Do not modify these contents since they'll be replaced
 * during the next generation.
 * Put overrides into the WebElements's subclass, OjDatePicker.ts.
 */
export class OjDatePickerBase extends OjWebElement {
  /**
   ...
   * The value of the date picker element, which must be an ISOString. See the Help documentation for more information.
