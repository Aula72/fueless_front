...
async function ojDrawerPopup(driver, by) {
    ...
    if (!(webEl instanceof OjDrawerPopup_1.OjDrawerPopup)) {
        ...
        throw Error(`ojDrawerPopup(${by}) created ${webEl.constructor.name} for <${tagName}>, but expected ${OjDrawerPopup_1.OjDrawerPopup.name}`);
    }
    return webEl;
}
exports.ojDrawerPopup = ojDrawerPopup;
(0, __1.register)('oj-drawer-popup', OjDrawerPopup_1.OjDrawerPopup);
