...
/**
 * This is the base class for oj-input-date WebElement, and is generated from the
 * component's metadata. Do not modify these contents since they'll be replaced
 * during the next generation.
 * Put overrides into the WebElements's subclass, OjInputDate.ts.
 */
export class OjInputDateBase extends OjWebElement {
  /**
   ...
   * The value of the input date element, which must be an ISOString. See the Help documentation for more information.
