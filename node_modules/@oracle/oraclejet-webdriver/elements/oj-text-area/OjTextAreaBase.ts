...
/**
 * This is the base class for oj-text-area WebElement, and is generated from the
 * component's metadata. Do not modify these contents since they'll be replaced
 * during the next generation.
 * Put overrides into the WebElements's subclass, OjTextArea.ts.
 */
export class OjTextAreaBase extends OjWebElement {
  /**
   ...
   * An object whose properties describe the maximum length attributes.
   ...
   * Specifies the maximum number of visible text lines of the textarea.
   * @return The value of <code>maxRows</code> property.
   *
   */
  public getMaxRows(): Promise<number> {
    return this.getProperty<number>('maxRows');
  }
   ...
   * Specifies the resize behavior, based upon native browser support. See the Help documentation for more information.
   ...
   *
   */
  public getRows(): Promise<number> {
    return this.getProperty<number>('rows');
  }
...
export interface Length {
  /**
   * Specifies the manner in which the text area characters has to be counted.
   */
  countBy: string;
  /**
   * The type of counter to display.
   */
  counter: string;
  /**
   * Specifies the maximum number of characters to be entered in the text area.
   */
  max: number | null;
}
