...
/**
 * This is the base class for oj-color-spectrum WebElement, and is generated from the
 * component's metadata. Do not modify these contents since they'll be replaced
 * during the next generation.
 * Put overrides into the WebElements's subclass, OjColorSpectrum.ts.
 */
export class OjColorSpectrumBase extends OjWebElement {
  /**
   ...
   * Retrieves the transient value of the component.
   * @return The value of <code>transientValue</code> property.
   *
   */
  public getTransientValue(): Promise<object> {
    return this.getProperty<object>('transientValue');
  }
   ...
   * Specifies the value of the element representing the current color.
...
export interface Translations {
  ...
  labelOpacity: string;
  /**
   * Label for spectrum thumb tooltip.
   */
  labelSatLum: string;
  /**
   * Label for spectrum thumb description.
   */
