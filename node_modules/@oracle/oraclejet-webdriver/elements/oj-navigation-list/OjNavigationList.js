...
class OjNavigationList extends OjNavigationListBase_1.OjNavigationListBase {
  ...
  Use the ExpandAllKeySet class to expand all items.
    ...
    async getExpanded() {
        await this.whenReady();
        let expanded = await this.getDriver().executeScript(['return Array.from(arguments[0].expanded.values());'].join('\n'), this);
        return expanded;
    }
    /**
